...
#  end
  ...
  class DatabaseDestroyWithGlobalConfig < Test::Unit::TestCase
    ...
    def setup
      ...
      redirected_connection = ActiveRecordTest::DatabaseDestroyWithGlobalConfig::Country.send(:undest_connection)
      MigrateRedirected.down CreateCountriesWithPrefix.new, redirected_connection
      MigrateRedirected.up CreateCountriesWithPrefix.new, redirected_connection
